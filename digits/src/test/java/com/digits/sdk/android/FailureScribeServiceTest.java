...
public class FailureScribeServiceTest {
    private FailureScribeService service;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        service = new FailureScribeService(client);
    }
    ...
    private EventNamespace createImpression() {
        return DigitsScribeConstants.DIGITS_EVENT_BUILDER
                .setComponent(FailureScribeService.FAILURE_COMPONENT)
