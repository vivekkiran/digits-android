...
public class PinCodeScribeServiceTest {
    private PinCodeScribeService service;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        service = new PinCodeScribeService(client);
    }
