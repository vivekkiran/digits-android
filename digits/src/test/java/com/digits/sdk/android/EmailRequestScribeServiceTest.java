...
public class EmailRequestScribeServiceTest {
    private EmailRequestScribeService service;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        service = new EmailRequestScribeService(client);
    }
    ...
    public void testConstructor_withNullScribeClient() throws Exception {
        new EmailRequestScribeService(null);
    }

    private EventNamespace createException() {
        return DigitsScribeConstants.DIGITS_EVENT_BUILDER
                .setComponent(EmailRequestScribeService.EMAIL_COMPONENT)
