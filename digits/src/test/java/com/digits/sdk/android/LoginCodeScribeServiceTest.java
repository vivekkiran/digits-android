...
public class LoginCodeScribeServiceTest {
    private LoginCodeScribeService service;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        service = new LoginCodeScribeService(client);
    }
